...
__all__ = ['MSELoss','CrossEntropyLoss','make_one_hot','MS_SSIM','CrossEntropyLabelSmooth','mixup_criterion','DiceLoss','FocalLoss','SoftIoULoss','CenterLoss','TripletLoss','LovaszSoftmax']
...
class CenterLoss(nn.Module):
    ...
    def __init__(self, num_classes=751, feat_dim=2048, use_gpu=True):
        ...
        self.centers = nn.Parameter(torch.randn(self.num_classes, self.feat_dim)).to(_device)
