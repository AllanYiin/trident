...
def make_vgg_layers(cfg, num_classes=1000, input_shape=(3, 224, 224), include_top=True):
    ...
    for v in cfg:
        if v == 'M':
            vgg.add_module('block{0}_pool'.format(block),
                           MaxPool2d(kernel_size=2, strides=2, use_bias=True, name='block{0}_pool'.format(block)))
            block += 1
            conv = 1
        else:
            if len(vgg) == 0:
                vgg.add_module('block{0}_conv{1}'.format(block, conv),
                               Conv2d((3, 3), v, auto_pad=True, activation=None, use_bias=True,
...
def VGG11(include_top=True,
    ...
    if pretrained:
        ...
        vgg11.model = _make_recovery_model_include_top(vgg11.model, input_shape=input_shape, include_top=include_top,
                                                       classes=classes, freeze_features=True)
...
def VGG13(include_top=True,
    ...
    if pretrained:
        ...
        vgg13.model = _make_recovery_model_include_top(vgg13.model, input_shape=input_shape, include_top=include_top,
                                                       classes=classes, freeze_features=True)
...
def VGG16(include_top=True,
    ...
    if pretrained:
        ...
        vgg16.model = _make_recovery_model_include_top(vgg16.model, input_shape=input_shape, include_top=include_top,
                                                       classes=classes, freeze_features=True)
...
def VGG19(include_top=True,
    ...
    if pretrained:
        ...
        vgg19.model = _make_recovery_model_include_top(vgg19.model, input_shape=input_shape, include_top=include_top,
                                                       classes=classes, freeze_features=True)
