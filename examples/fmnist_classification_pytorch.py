...
class GcdNet_1(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 16, 3, padding=1)
        self.b1=T.GcdConv2d_Block_1((3, 3), 24, 1, auto_pad=True, activation='leaky_relu', divisor_rank=0)
        self.b2=T.GcdConv2d_Block_1((3, 3), 40, 2, auto_pad=True, activation='leaky_relu', divisor_rank=0,self_norm=False,normalization='batch')
        self.b2_1 = T.GcdConv2d_Block_1((1,1), 120, 1, auto_pad=True, activation='leaky_relu', divisor_rank=0)
        self.b2_2 = T.GcdConv2d_Block_1((3, 3),120, 1, auto_pad=True, activation='leaky_relu', divisor_rank=0)
        self.b2_3 = T.GcdConv2d_Block_1((1, 1), 40, 1, auto_pad=True, activation=None, divisor_rank=0)

        self.b3=T.GcdConv2d_Block_1((3, 3), 88, 1, auto_pad=True, activation='leaky_relu', self_norm=False,normalization='batch',divisor_rank=0)
        self.b4=T.GcdConv2d_Block_1((3, 3), 104, 2, auto_pad=True, activation='leaky_relu', divisor_rank=0,self_norm=False,normalization='batch')
        # self.b5=T.GcdConv2d_Block((3, 3), 104, 1, auto_pad=True, activation='leaky_relu6', divisor_rank=0)
        self.b6=T.GcdConv2d_1((1, 1), 10, 1, auto_pad=True, activation=None ,divisor_rank=0,self_norm=False)
    ...
    def forward(self, x):
        ...
        out=out.view(out.size(0),out.size(1))
        out=F.sigmoid(out)
        return torch.clamp(out,1e-8,1-1e-8)
